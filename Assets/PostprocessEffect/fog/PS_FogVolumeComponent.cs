...
[VolumeComponentMenu("Post-processing Custom/PS_Fog")]
[VolumeRequiresRendererFeatures(typeof(PS_FogRendererFeature))]
[SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
public sealed class PS_FogVolumeComponent : VolumeComponent, IPostProcessComponent
{
    public PS_FogVolumeComponent()
    {
        displayName = "PS_Fog";
    }

    public ColorParameter fogColor = new ColorParameter(new Color(0f, 0f, 0f, 1f));
    public ClampedFloatParameter FogDensity = new ClampedFloatParameter(0.5f, 0f, 10f);
    public ClampedFloatParameter FogStart = new ClampedFloatParameter(1f, 0f, 100f);
    public ClampedFloatParameter FogEnd = new ClampedFloatParameter(1f, 0f, 100f);
    public ClampedFloatParameter FogHeight = new ClampedFloatParameter(1f, 0f, 100f);
    public ClampedFloatParameter FogFalloff = new ClampedFloatParameter(1f, 0f, 10f);
    public Vector3Parameter NoiseVector = new Vector3Parameter(new Vector3(0f, 0f,0f));
    public ClampedFloatParameter MaxFogBlendFactor = new ClampedFloatParameter(.75f, 0f, 1f);
    
    public bool IsActive()
    {
        return FogDensity.value > 0f;
    }
}
